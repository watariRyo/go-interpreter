...
func TestFunctionObject(t *testing.T) {
	...
	if fn.Parameters[0].String()!= "x" {
        t.Fatalf("function has wrong parameter name. got=%q, want x", fn.Parameters[0].String())
    }

	expectedBody := "(x + 2)"

	if fn.Body.String()!= expectedBody {
        t.Fatalf("function body is wrong. got=%q, want %q", fn.Body.String(), expectedBody)
    }
}
